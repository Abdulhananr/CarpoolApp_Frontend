...
function Profilepic() {
    ...
    const Change = async () => {
        ...
        if (image === null) {
            ...
            fetch('http://' + ip_add['ip'] + '/api/Changepicture/' + val['id'] + '/' + ID, {
                method: 'GET'
            })
                .then((response) => response.json())
                .then((responseJson) => {
            ...
            <View style={styles.formContainer}>
                ...
                <View style={styles.card}>
                    ...
                    <TouchableOpacity style={styles.button} onPress={pickImage}>
                        {isLoading == false ? <Text style={styles.buttonText}>Select New Profile Picture</Text> : <ActivityIndicator size="small" color="#000000" />}
                    </TouchableOpacity>
