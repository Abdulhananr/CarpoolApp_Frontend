...
function ClientMap({route}) {
    ...
    const Getuserdetails = async (id) => {
        const ip = await AsyncStorage.getItem('@Data_Ip')
        const ip_add = JSON.parse(ip)
        fetch('http://' + ip_add['ip'] + '/api/Customer/' + route.params.clientid, {
            method: 'GET'
        })
            .then((response) => response.json())
            .then((responseJson) => {
                ...
                buketdata(responseJson["as_driver_bucket"])
    ...
    const buketdata = async (id) => {
        const ip = await AsyncStorage.getItem('@Data_Ip')
        const ip_add = JSON.parse(ip)
        fetch('http://' + ip_add['ip'] + '/api/Dlocation/' + id, {
            method: 'GET'
        })
            .then((response) => response.json())
            .then((responseJson) => {
