...
import { StyleSheet, View, Text, Image, TouchableOpacity, Linking, FlatList } from 'react-native';
function Redeem1(props) {
    ...
    return (
      <View style={styles.productCard}>
        ...
        <View style={styles.productInfo}>
          ...
          <Text style={styles.productPrice}>Points {item.price.toFixed(2)} <Text style={styles.productPriceText}>per item</Text></Text>
        </View>
